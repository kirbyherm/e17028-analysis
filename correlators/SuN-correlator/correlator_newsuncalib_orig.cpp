...
void SuN::GainMatchAndCalibrate(){
  ...
  ecSEG[7] = 0.435 * erSEG[7] - 7.1781;
  */
  ecSEG[0] = 0.4292 * erSEG[0] - 0.8324;
  ecSEG[1] = 0.4332 * erSEG[1] - 1.4164;
  ecSEG[2] = 0.4234 * erSEG[2] - 1.4426;
  ecSEG[3] = 0.4296 * erSEG[3] - 4.0820;
  // Top segments
  ecSEG[4] = 0.4296 * erSEG[4] - 3.6111;
  ecSEG[5] = 0.4337 * erSEG[5] - 1.5122;
  ecSEG[6] = 0.4291 * erSEG[6] - 1.0903;
  ecSEG[7] = 0.4339 * erSEG[7] - 4.3569;
...
int main(int argc, char* argv[]){
  ...
  TFile* fOut = new TFile(Form("Run%i_SuN_%ims_%s.root",std::stoi(argv[1]),std::stoi(argv[5])*1000,argv[7]),"RECREATE");
