...
int DSSD::Calibrate(){
  ...
  e_high_cal_thresholds_lower_bounds[0][0]  = 530-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][1]  = 450-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][2]  = 425-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][3]  = 420-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][4]  = 410-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][5]  = 400-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][6]  = 400-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][7]  = 420-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][8]  = 400-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][9]  = 450-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][10] = 420-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][11] = 430-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][12] = 400-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][13] = 420-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][14] = 400-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][15] = 360-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][16] = 340-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][17] = 320-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][18] = 350-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][19] = 340-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][20] = 320-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][21] = 280-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][22] = 320-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][23] = 330-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][24] = 300-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][25] = 330-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][26] = 350-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][27] = 370-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][28] = 340-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][29] = 350-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][30] = 340-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][31] = 360-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][32] = 450-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][33] = 430-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][34] = 450-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][35] = 450-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][36] = 450-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][37] = 475-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][38] = 400-reduce;// 1;
  e_high_cal_thresholds_lower_bounds[0][39] = 375-reduce;// 1;

  // High gain, front side, lower bound

  e_high_cal_thresholds_lower_bounds[1][0]  = 275-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][1]  = 300-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][2]  = 350-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][3]  = 375-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][4]  = 280-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][5]  = 380-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][6]  = 350-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][7]  = 350-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][8]  = 400-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][9]  = 275-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][10] = 260-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][11] = 380-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][12] = 400-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][13] = 390-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][14] = 340-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][15] = 340-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][16] = 410-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][17] = 380-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][18] = 330-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][19] = 380-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][20] = 365-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][21] = 330-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][22] = 330-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][23] = 300-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][24] = 430-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][25] = 410-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][26] = 400-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][27] = 410-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][28] = 390-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][29] = 340-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][30] = 375-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][31] = 455-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][32] = 330-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][33] = 375-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][34] = 375-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][35] = 380-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][36] = 380-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][37] = 350-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][38] = 330-reduce;//1;
  e_high_cal_thresholds_lower_bounds[1][39] = 400-reduce;//1;
...
//	std::cout << "imax " << imax << " imin " << imin << std::endl;
...
//              std::cout << "not sequential overflow back" << ", prev: " << prev_overflow << ", now: " << j << std::endl;
            overflows.push_back(j);
//            std::cout << overflows.back() << " "<< j << std::endl;
            overflow += j;
            num_overflow++;
            multover += 1;
            prev_overflow = j;
...
//        std::cout << e_low_cal[i][j] << ", " << e_strip_low_back << ", test: " << bool(e_low_cal[i][j] >= e_strip_low_back) << std::endl;
	    ...
	    c_strip_low_back = j;
          if (overflows.size() > 0 ){
//            std::cout << "back " << overflows.back() << " "<< j << " " << c_strip_low_back << std::endl;
//                for (int of = 0; of < overflows.size(); of++)
//                   std::cout << overflows[of] << ", ";
//               std::cout << std::endl;
          }
...
//        std::cout << e_low_cal[i][j] << ", " << e_strip_low_front << ", test: " << bool(e_low_cal[i][j] >= e_strip_low_front) << std::endl;
          if (e_low_cal[i][j] >= e_strip_low_front){
	    c_strip_low_front = j;
          if (overflows.size() > 0 ){
//            std::cout << "front " <<  overflows.back() << " "<< j << " " << c_strip_low_front << std::endl;
//                for (int of = 0; of < overflows.size(); of++)
//                   std::cout << overflows[of] << ", ";
//               std::cout << std::endl;
          }
...
//        std::cout << t_low_raw[i][j] << ", " << t_low_cal[i][j] << ", " << t_strip_low_front << std::endl;
	  }
//        std::cout << e_low_cal[i][j] << ", " << e_strip_low_front << ", test: " << bool(e_low_cal[i][j] >= e_strip_low_front) << std::endl;
    }
...
//        if (overflow == 0){ mid = int(round(stripno/totenergy)); }
        if (overflows.size() <= 1){ 
            ...
            if(i==1){mid=c_strip_low_front; }
                ...
                mid = overflows[overflows.size()/2];
//                std::cout << "i: " << i << " j: " << j << " overflows: ";
//                for (int of = 0; of < overflows.size(); of++)
//                   std::cout << overflows[of] << ", ";
//                std::cout << " mid: " << mid << std::endl;
//           if (TMath::Abs(int(round(overflow/multover)) - int(round(stripno/totenergy))) <= 1){

//             mid = int(round(stripno/totenergy));
//                if (std::find(overflows.begin(), overflows.end(), mid) != overflows.end()){}
//                else 
//                {
//                std::cout << ">1 overflow, i: " << i << " mid: " << mid << " c_back: " << c_strip_low_back << " c_front: " << c_strip_low_front << std::endl;
//                for (int of = 0; of < overflows.size(); of++)
//                   std::cout << overflows[of] << ", ";
//                std::cout << std::endl;
//                mid = overflows[overflows.size()/2];
...
//           }
//           else {
//             mid = int(round(overflow/multover));
...
//*/
    ...
    total_overflows += overflows.size();
  }
